...
class GuiArticleDetailsWindowHandler(GObject.GObject):
    ...
    def article_clicked_in_details_window(
        self, placeholder_one, article_id, placeholder_two
    ):
    ...
    def show_article_details(self, article_details_window, url):
        try:
            ...
            article_details_window.update_article_information(
                url, self.citationmap, article
            )
        except KeyError:
    ...
    def listen_to_signals_from_window(self, article_details_window):
        article_details_window.connect(
            "citation_clicked", self.article_clicked_in_details_window, None
        )
